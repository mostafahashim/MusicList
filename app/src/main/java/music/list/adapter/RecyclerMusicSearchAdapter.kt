...
class RecyclerMusicSearchAdapter(
    var musicModels: ArrayList<MusicModel>,
    ...
    override fun getItemViewType(position: Int): Int {
        return if (musicModels[position].holderType!!.isEmpty()) ItemViewData else ItemViewProgress
    }
...
//            )
        ...
        holder.binding.model = musicModels[holder.adapterPosition]
    ...
    fun setList(list: ArrayList<MusicModel>) {
